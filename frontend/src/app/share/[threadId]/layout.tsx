...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Dimatic Texo',
    description: 'Replay this Agent conversation on Dimatic Texo',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Dimatic Texo';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Dimatic Texo';

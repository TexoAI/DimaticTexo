                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the Texo website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Texo website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Texo is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Texo logos, marks, and designations are trademarks or
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Texo in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Texo does not collect biometric or identifying

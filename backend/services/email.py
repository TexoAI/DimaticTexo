...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Texo — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Dimatic Texo</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Dimatic Texo Logo" class="logo">
    </div>
    <h1>Welcome to Dimatic Texo!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Dimatic Texo — we're excited to have you on board!</strong></em></p>

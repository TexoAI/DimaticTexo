...
MODELS = {
    ...
    "openrouter/z-ai/glm-4.5": {
        ...
        "pricing": {
            "input_cost_per_million_tokens": 0.57,
            "output_cost_per_million_tokens": 2.15
        },
        "tier_availability": ["free", "paid"]
    },
    "openrouter/z-ai/glm-4.5-air": {
        "aliases": ["GLM 4.5 Air", "glm-4.5-air", "z-ai/glm-4.5-air"],
        "pricing": {
    ...
    "openrouter/z-ai/glm-4.5v": {
        "aliases": ["GLM 4.5V", "glm-4.5v", "z-ai/glm-4.5v"],
        "pricing": {
            "input_cost_per_million_tokens": 0.50,
            "output_cost_per_million_tokens": 1.70
        },
        "tier_availability": ["free", "paid"]
    },   
}
